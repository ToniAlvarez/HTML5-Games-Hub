...
function crearDOM() {
    ...
    //Recuperar el elemento padre, donde se ejecutará el juego
    var gameContainer = document.getElementById('game-container');

    //Crear todos los elementos necesarios para el juego
    var divTablero = document.createElement("DIV");
    var divInformacion = document.createElement("DIV");
    var divMinasRestantes = document.createElement("DIV");
    var divTiempo = document.createElement("DIV");
    var divCaraEstado = document.createElement("DIV");

    var tabla = document.createElement("TABLE");

    var imgMinasCentenas = document.createElement("IMG");
    var imgMinasDecenas = document.createElement("IMG");
    var imgMinasUnidades = document.createElement("IMG");

    var tiempoCentenas = document.createElement("IMG");
    var tiempoDecenas = document.createElement("IMG");
    var tiempoUnidades = document.createElement("IMG");

    //Poner los IDs y las clases a los elementos
    divTablero.id = 'tablero';
    divInformacion.id = 'informacion';
    divMinasRestantes.id = 'minas-restantes';
    divTiempo.id = 'tiempo';
    divCaraEstado.id = 'cara-estado';
    divCaraEstado.className = 'cara-sonriente cara-normal';

    tabla.id = 'tabla';

    imgMinasCentenas.id = 'minas-centenas';
    imgMinasDecenas.id = 'minas-decenas';
    imgMinasUnidades.id = 'minas-unidades';

    tiempoCentenas.id = 'tiempo-centenas';
    tiempoDecenas.id = 'tiempo-decenas';
    tiempoUnidades.id = 'tiempo-unidades';

    tiempoCentenas.src = '/gamedata/buscaminas/img/contador0.png';
    tiempoDecenas.src = '/gamedata/buscaminas/img/contador0.png';
    tiempoUnidades.src = '/gamedata/buscaminas/img/contador0.png';

    //Añadir los elementos al DOM
    divMinasRestantes.appendChild(imgMinasCentenas);
    divMinasRestantes.appendChild(imgMinasDecenas);
    divMinasRestantes.appendChild(imgMinasUnidades);

    divTiempo.appendChild(tiempoCentenas);
    divTiempo.appendChild(tiempoDecenas);
    divTiempo.appendChild(tiempoUnidades);

    divInformacion.appendChild(divMinasRestantes);
    divInformacion.appendChild(divTiempo);
    divInformacion.appendChild(divCaraEstado);

    divTablero.appendChild(divInformacion);
    divTablero.appendChild(tabla);

    gameContainer.appendChild(divTablero);
...
function actualizarContadorMinas() {
    ...
    contadorUnidades.src = "/gamedata/buscaminas/img/contador" + unidades + ".png";
    contadorDecenas.src = "/gamedata/buscaminas/img/contador" + decenas + ".png";
    contadorCentenas.src = "/gamedata/buscaminas/img/contador" + centenas + ".png";
}
